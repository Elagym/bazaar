                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <c:forEach var="proposition" items="${user.propositions}">
                                        <tr>
                                            ...
                                            <td><a role="button" data-toggle="collapse" href="#prop${proposition.id}" aria-expanded="false" aria-controls="prop${proposition.id}" onclick="consultProp(${proposition.id}, 'profile'); decrementIfNotViewed(${proposition.viewed});">${proposition.title}</a></td>
